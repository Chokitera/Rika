...
{
    public partial class FrmTelaModelo : Form
    {
        //Inicialização
        ...
        private void FrmTelaModelo_Paint(object sender, PaintEventArgs e)
        {
            // Ajusta as bordas
        ...
        public FrmTelaModelo(object Formulario)
        {
            InitializeComponent();

            ColocarFormNoPainel(Formulario); //Inicializa com o formulário em tela

            panelConteudo.Size = new Size(1406, 689);
        }
