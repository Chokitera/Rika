...
namespace Rika.views
{
    public partial class FrmConsultaPassagem : Form
    {
        ...
        private void pnlPassagem_Paint(object sender, PaintEventArgs e)
        {
            // Ajusta as bordas
        ...
        public void ListarPassagens()
        {
            ...
            {
                Cod_Passagem = "%" + txtNome.Text + "%" //Porcentagem utilizada no .LIKE
            };

            //Consulta os paises e atribui a DataGrid
            tabelaPassagens.DataSource = passagemController.ConsultarPassagens(passagem);
        }
        #endregion
