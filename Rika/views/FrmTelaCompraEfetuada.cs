...
{
    public partial class FrmTelaCompraEfetuada : Form
    {
        public FrmTelaCompraEfetuada()
        {
            InitializeComponent();
        }
        ...
        private void FrmTelaCompraEfetuada_Paint(object sender, PaintEventArgs e)
        {
            // Ajusta as bordas
        ...
        private void lblVoltarInicio_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            this.Close();
        }
    }
